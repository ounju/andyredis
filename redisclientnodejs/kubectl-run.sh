echo "kubectl run andy-redis-test --rm -it --restart='Never' --image andy/redistest -- bash"
...
kubectl run andy-redis-test --rm -it --restart='Never' --image ounju/redistest -- bash
